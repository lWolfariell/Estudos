...
Você está criando um aplicativo de entrega de comida e precisa calcular o 
preço final do pedido do usuário. 
...
const valorHamburguer = 10.00
const quantidadeHamburguer = 2
const valorBebida = 5.00
const quantidadeBebida = 1
const valorPago = 30

    let totalHamburger = quantidadeHamburguer * valorHamburguer;
    let totalBebida = quantidadeBebida * valorBebida;

    let totalPedido = (totalHamburger + totalBebida);
    let troco = (valorPago - totalPedido);

    console.log(`O preço final do pedido é R$ ${totalPedido}.Seu troco é R$ ${troco}.`)
